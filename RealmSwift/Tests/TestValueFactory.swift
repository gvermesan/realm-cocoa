...
protocol ListValueFactoryOptional: ListValueFactory where Self: _PersistableInOptional {
    static var optArray: KeyPath<ListRoot, List<Self?>> { get }
}

protocol SetValueFactoryOptional: SetValueFactory where Self: _PersistableInOptional {
    static var optMutableSet: KeyPath<SetRoot, MutableSet<Self?>> { get }
}

protocol MapValueFactoryOptional: MapValueFactory where Self: _PersistableInOptional {
    static var optMap: KeyPath<MapRoot, Map<String, Self?>> { get }
}

// MARK: Optional

extension Optional: ValueFactory where Wrapped: ValueFactory & _PersistableInOptional {
    static func values() -> [Self] {
...
extension Optional: NumericValueFactory where Wrapped: NumericValueFactory & _PersistableInOptional {
