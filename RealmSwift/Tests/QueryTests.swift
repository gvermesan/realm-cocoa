...
class QueryTests: TestCase {
    ...
    override func setUp() {
        ...
        try! realm.write {
            ...
            objModernAllTypesObject.intCol = 6
            ...
            objAllCustomPersistableTypes.int = IntWrapper(persistedValue: 6)
            ...
            objModernAllTypesObject.optIntCol = 6
            ...
            objAllCustomPersistableTypes.optInt = IntWrapper(persistedValue: 6)
            ...
            objModernAllTypesObject.arrayInt.append(objectsIn: [5, 6])
            ...
            objCustomPersistableCollections.listInt.append(objectsIn: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])
            ...
            objModernAllTypesObject.arrayOptInt.append(objectsIn: [5, 6])
            ...
            objCustomPersistableCollections.listOptInt.append(objectsIn: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])
            ...
            objModernAllTypesObject.setInt.insert(objectsIn: [5, 6])
            ...
            objCustomPersistableCollections.setInt.insert(objectsIn: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])
            ...
            objModernAllTypesObject.setOptInt.insert(objectsIn: [5, 6])
            ...
            objCustomPersistableCollections.setOptInt.insert(objectsIn: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])
            ...
            objModernAllTypesObject.mapInt["foo"] = 5
            objModernAllTypesObject.mapInt["bar"] = 6
            ...
            objCustomPersistableCollections.mapInt["foo"] = IntWrapper(persistedValue: 5)
            objCustomPersistableCollections.mapInt["bar"] = IntWrapper(persistedValue: 6)
            ...
            objModernAllTypesObject.mapOptInt["foo"] = 5
            objModernAllTypesObject.mapOptInt["bar"] = 6
            ...
            objCustomPersistableCollections.mapOptInt["foo"] = IntWrapper(persistedValue: 5)
            objCustomPersistableCollections.mapOptInt["bar"] = IntWrapper(persistedValue: 6)
    ...
    func testEquals() {
        ...
        validateEquals("int", \Query<AllCustomPersistableTypes>.int, IntWrapper(persistedValue: 6))
        ...
        validateEquals("optInt", \Query<AllCustomPersistableTypes>.optInt, IntWrapper(persistedValue: 6))
    ...
    func testEqualMappedToEmbeddedObject() {
        ...
        assertQuery(LinkToAllCustomPersistableTypes.self, "(ANY map.values.object.value == %@)", 2, count: 1) {
            $0.map.values.object.persistableValue.value == 2
        }
        assertQuery(LinkToAllCustomPersistableTypes.self, "(ANY map.values.object == %@)", EmbeddedObjectWrapper(value: 2), count: 1) {
            $0.map.values.object == EmbeddedObjectWrapper(value: 2)
        }
        assertQuery(LinkToAllCustomPersistableTypes.self, "(ANY map.values.object.value == %@)", 3, count: 0) {
            $0.map.values.object.persistableValue.value == 3
        }
        assertQuery(LinkToAllCustomPersistableTypes.self, "(ANY map.values.object == %@)", EmbeddedObjectWrapper(value: 3), count: 0) {
    ...
    func testNumericComparisons() {
        ...
        validateNumericComparisons("int", \Query<AllCustomPersistableTypes>.int, IntWrapper(persistedValue: 6))
        ...
        validateNumericComparisons("optInt", \Query<AllCustomPersistableTypes>.optInt, IntWrapper(persistedValue: 6))
    ...
    func testCollectionContainsRange() {
        ...
        assertQuery(CustomPersistableCollections.self, "((listInt.@min >= %@) && (listInt.@max <= %@))",
                    values: [IntWrapper(persistedValue: 5).persistableValue, IntWrapper(persistedValue: 6).persistableValue], count: 1) {
            $0.listInt.persistableValue.contains(IntWrapper(persistedValue: 5).persistableValue...IntWrapper(persistedValue: 6).persistableValue)
        }
        assertQuery(CustomPersistableCollections.self, "((listInt.@min >= %@) && (listInt.@max < %@))",
                    values: [IntWrapper(persistedValue: 5).persistableValue, IntWrapper(persistedValue: 6).persistableValue], count: 0) {
            $0.listInt.persistableValue.contains(IntWrapper(persistedValue: 5).persistableValue..<IntWrapper(persistedValue: 6).persistableValue)
        }
        ...
        assertQuery(CustomPersistableCollections.self, "((listOptInt.@min >= %@) && (listOptInt.@max <= %@))",
                    values: [IntWrapper(persistedValue: 5).persistableValue, IntWrapper(persistedValue: 6).persistableValue], count: 1) {
            $0.listOptInt.persistableValue.contains(IntWrapper(persistedValue: 5).persistableValue...IntWrapper(persistedValue: 6).persistableValue)
        }
        assertQuery(CustomPersistableCollections.self, "((listOptInt.@min >= %@) && (listOptInt.@max < %@))",
                    values: [IntWrapper(persistedValue: 5).persistableValue, IntWrapper(persistedValue: 6).persistableValue], count: 0) {
            $0.listOptInt.persistableValue.contains(IntWrapper(persistedValue: 5).persistableValue..<IntWrapper(persistedValue: 6).persistableValue)
        ...
        assertQuery(CustomPersistableCollections.self, "((setInt.@min >= %@) && (setInt.@max <= %@))",
                    values: [IntWrapper(persistedValue: 5).persistableValue, IntWrapper(persistedValue: 6).persistableValue], count: 1) {
            $0.setInt.persistableValue.contains(IntWrapper(persistedValue: 5).persistableValue...IntWrapper(persistedValue: 6).persistableValue)
        }
        assertQuery(CustomPersistableCollections.self, "((setInt.@min >= %@) && (setInt.@max < %@))",
                    values: [IntWrapper(persistedValue: 5).persistableValue, IntWrapper(persistedValue: 6).persistableValue], count: 0) {
            $0.setInt.persistableValue.contains(IntWrapper(persistedValue: 5).persistableValue..<IntWrapper(persistedValue: 6).persistableValue)
        ...
        assertQuery(CustomPersistableCollections.self, "((setOptInt.@min >= %@) && (setOptInt.@max <= %@))",
                    values: [IntWrapper(persistedValue: 5).persistableValue, IntWrapper(persistedValue: 6).persistableValue], count: 1) {
            $0.setOptInt.persistableValue.contains(IntWrapper(persistedValue: 5).persistableValue...IntWrapper(persistedValue: 6).persistableValue)
        }
        assertQuery(CustomPersistableCollections.self, "((setOptInt.@min >= %@) && (setOptInt.@max < %@))",
                    values: [IntWrapper(persistedValue: 5).persistableValue, IntWrapper(persistedValue: 6).persistableValue], count: 0) {
            $0.setOptInt.persistableValue.contains(IntWrapper(persistedValue: 5).persistableValue..<IntWrapper(persistedValue: 6).persistableValue)
        ...
        assertQuery(CustomPersistableCollections.self, "((mapInt.@min >= %@) && (mapInt.@max <= %@))",
                    values: [IntWrapper(persistedValue: 5).persistableValue, IntWrapper(persistedValue: 6).persistableValue], count: 1) {
            $0.mapInt.persistableValue.contains(IntWrapper(persistedValue: 5).persistableValue...IntWrapper(persistedValue: 6).persistableValue)
        }
        assertQuery(CustomPersistableCollections.self, "((mapInt.@min >= %@) && (mapInt.@max < %@))",
                    values: [IntWrapper(persistedValue: 5).persistableValue, IntWrapper(persistedValue: 6).persistableValue], count: 0) {
            $0.mapInt.persistableValue.contains(IntWrapper(persistedValue: 5).persistableValue..<IntWrapper(persistedValue: 6).persistableValue)
        ...
        assertQuery(CustomPersistableCollections.self, "((mapOptInt.@min >= %@) && (mapOptInt.@max <= %@))",
                    values: [IntWrapper(persistedValue: 5).persistableValue, IntWrapper(persistedValue: 6).persistableValue], count: 1) {
            $0.mapOptInt.persistableValue.contains(IntWrapper(persistedValue: 5).persistableValue...IntWrapper(persistedValue: 6).persistableValue)
        }
        assertQuery(CustomPersistableCollections.self, "((mapOptInt.@min >= %@) && (mapOptInt.@max < %@))",
                    values: [IntWrapper(persistedValue: 5).persistableValue, IntWrapper(persistedValue: 6).persistableValue], count: 0) {
            $0.mapOptInt.persistableValue.contains(IntWrapper(persistedValue: 5).persistableValue..<IntWrapper(persistedValue: 6).persistableValue)
    ...
    func testListContainsAnyInObject() {
        ...
        assertQuery(CustomPersistableCollections.self, "(ANY listInt IN %@)",
                    values: [NSArray(array: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])], count: 1) {
            $0.listInt.containsAny(in: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])
        }
        ...
        assertQuery(CustomPersistableCollections.self, "(ANY listOptInt IN %@)",
                    values: [NSArray(array: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])], count: 1) {
            $0.listOptInt.containsAny(in: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])
        }
    ...
    func testCollectionFromProperty() {
        ...
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(intCol == %@)", 6) {
            $0.intCol == 6
        }
        ...
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(int == %@)", IntWrapper(persistedValue: 6)) {
            $0.int == IntWrapper(persistedValue: 6)
        }
        ...
        assertCollectionQuery(LinkToModernAllTypesObject.self, "(optIntCol == %@)", 6) {
            $0.optIntCol == 6
        }
        ...
        assertCollectionQuery(LinkToAllCustomPersistableTypes.self, "(optInt == %@)", IntWrapper(persistedValue: 6)) {
            $0.optInt == IntWrapper(persistedValue: 6)
        }
    ...
    func testSetContainsAnyInObject() {
        ...
        assertQuery(CustomPersistableCollections.self, "(ANY setInt IN %@)",
                    values: [NSArray(array: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])], count: 1) {
            $0.setInt.containsAny(in: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])
        }
        ...
        assertQuery(CustomPersistableCollections.self, "(ANY setOptInt IN %@)",
                    values: [NSArray(array: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])], count: 1) {
            $0.setOptInt.containsAny(in: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])
        }
    ...
    func testMapAllValues() {
        validateEquals("mapBool.@allValues", \Query<ModernAllTypesObject>.mapBool.values, true)

        validateEquals("mapInt.@allValues", \Query<ModernAllTypesObject>.mapInt.values, 5, notEqualCount: 1)
        validateNumericComparisons("mapInt.@allValues", \Query<ModernAllTypesObject>.mapInt.values, 6, ltCount: 1)

        validateEquals("mapInt8.@allValues", \Query<ModernAllTypesObject>.mapInt8.values, Int8(8), notEqualCount: 1)
        validateNumericComparisons("mapInt8.@allValues", \Query<ModernAllTypesObject>.mapInt8.values, Int8(9), ltCount: 1)

        validateEquals("mapInt16.@allValues", \Query<ModernAllTypesObject>.mapInt16.values, Int16(16), notEqualCount: 1)
        validateNumericComparisons("mapInt16.@allValues", \Query<ModernAllTypesObject>.mapInt16.values, Int16(17), ltCount: 1)

        validateEquals("mapInt32.@allValues", \Query<ModernAllTypesObject>.mapInt32.values, Int32(32), notEqualCount: 1)
        validateNumericComparisons("mapInt32.@allValues", \Query<ModernAllTypesObject>.mapInt32.values, Int32(33), ltCount: 1)

        validateEquals("mapInt64.@allValues", \Query<ModernAllTypesObject>.mapInt64.values, Int64(64), notEqualCount: 1)
        validateNumericComparisons("mapInt64.@allValues", \Query<ModernAllTypesObject>.mapInt64.values, Int64(65), ltCount: 1)

        validateEquals("mapFloat.@allValues", \Query<ModernAllTypesObject>.mapFloat.values, Float(5.55444333), notEqualCount: 1)
        validateNumericComparisons("mapFloat.@allValues", \Query<ModernAllTypesObject>.mapFloat.values, Float(6.55444333), ltCount: 1)

        validateEquals("mapDouble.@allValues", \Query<ModernAllTypesObject>.mapDouble.values, 123.456, notEqualCount: 1)
        validateNumericComparisons("mapDouble.@allValues", \Query<ModernAllTypesObject>.mapDouble.values, 234.567, ltCount: 1)

        validateEquals("mapString.@allValues", \Query<ModernAllTypesObject>.mapString.values, "Foo", notEqualCount: 1)
        validateStringOperations("mapString.@allValues", \Query<ModernAllTypesObject>.mapString.values,
        ...
        validateEquals("mapBinary.@allValues", \Query<ModernAllTypesObject>.mapBinary.values, Data(count: 64), notEqualCount: 1)

        validateEquals("mapDate.@allValues", \Query<ModernAllTypesObject>.mapDate.values, Date(timeIntervalSince1970: 1000000), notEqualCount: 1)
        validateNumericComparisons("mapDate.@allValues", \Query<ModernAllTypesObject>.mapDate.values, Date(timeIntervalSince1970: 2000000), ltCount: 1)

        validateEquals("mapDecimal.@allValues", \Query<ModernAllTypesObject>.mapDecimal.values, Decimal128(123.456), notEqualCount: 1)
        validateNumericComparisons("mapDecimal.@allValues", \Query<ModernAllTypesObject>.mapDecimal.values, Decimal128(234.567), ltCount: 1)

        validateEquals("mapObjectId.@allValues", \Query<ModernAllTypesObject>.mapObjectId.values, ObjectId("61184062c1d8f096a3695046"), notEqualCount: 1)

        validateEquals("mapUuid.@allValues", \Query<ModernAllTypesObject>.mapUuid.values, UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09e")!, notEqualCount: 1)

        validateEquals("mapAny.@allValues", \Query<ModernAllTypesObject>.mapAny.values, AnyRealmValue.objectId(ObjectId("61184062c1d8f096a3695046")), notEqualCount: 1)

        validateEquals("mapInt.@allValues", \Query<ModernCollectionsOfEnums>.mapInt.values, EnumInt.value1, notEqualCount: 1)
        validateNumericComparisons("mapInt.@allValues", \Query<ModernCollectionsOfEnums>.mapInt.values, .value2, ltCount: 1)

        validateEquals("mapInt8.@allValues", \Query<ModernCollectionsOfEnums>.mapInt8.values, EnumInt8.value1, notEqualCount: 1)
        validateNumericComparisons("mapInt8.@allValues", \Query<ModernCollectionsOfEnums>.mapInt8.values, .value2, ltCount: 1)

        validateEquals("mapInt16.@allValues", \Query<ModernCollectionsOfEnums>.mapInt16.values, EnumInt16.value1, notEqualCount: 1)
        validateNumericComparisons("mapInt16.@allValues", \Query<ModernCollectionsOfEnums>.mapInt16.values, .value2, ltCount: 1)

        validateEquals("mapInt32.@allValues", \Query<ModernCollectionsOfEnums>.mapInt32.values, EnumInt32.value1, notEqualCount: 1)
        validateNumericComparisons("mapInt32.@allValues", \Query<ModernCollectionsOfEnums>.mapInt32.values, .value2, ltCount: 1)

        validateEquals("mapInt64.@allValues", \Query<ModernCollectionsOfEnums>.mapInt64.values, EnumInt64.value1, notEqualCount: 1)
        validateNumericComparisons("mapInt64.@allValues", \Query<ModernCollectionsOfEnums>.mapInt64.values, .value2, ltCount: 1)

        validateEquals("mapFloat.@allValues", \Query<ModernCollectionsOfEnums>.mapFloat.values, EnumFloat.value1, notEqualCount: 1)
        validateNumericComparisons("mapFloat.@allValues", \Query<ModernCollectionsOfEnums>.mapFloat.values, .value2, ltCount: 1)

        validateEquals("mapDouble.@allValues", \Query<ModernCollectionsOfEnums>.mapDouble.values, EnumDouble.value1, notEqualCount: 1)
        validateNumericComparisons("mapDouble.@allValues", \Query<ModernCollectionsOfEnums>.mapDouble.values, .value2, ltCount: 1)

        validateEquals("mapString.@allValues", \Query<ModernCollectionsOfEnums>.mapString.values, EnumString.value1, notEqualCount: 1)
        validateStringOperations("mapString.@allValues", \Query<ModernCollectionsOfEnums>.mapString.values,
        ...
        validateEquals("mapBool.@allValues", \Query<CustomPersistableCollections>.mapBool.values, BoolWrapper(persistedValue: true))

        validateEquals("mapInt.@allValues", \Query<CustomPersistableCollections>.mapInt.values, IntWrapper(persistedValue: 5), notEqualCount: 1)
        validateNumericComparisons("mapInt.@allValues", \Query<CustomPersistableCollections>.mapInt.values, IntWrapper(persistedValue: 6), ltCount: 1)

        validateEquals("mapInt8.@allValues", \Query<CustomPersistableCollections>.mapInt8.values, Int8Wrapper(persistedValue: Int8(8)), notEqualCount: 1)
        validateNumericComparisons("mapInt8.@allValues", \Query<CustomPersistableCollections>.mapInt8.values, Int8Wrapper(persistedValue: Int8(9)), ltCount: 1)

        validateEquals("mapInt16.@allValues", \Query<CustomPersistableCollections>.mapInt16.values, Int16Wrapper(persistedValue: Int16(16)), notEqualCount: 1)
        validateNumericComparisons("mapInt16.@allValues", \Query<CustomPersistableCollections>.mapInt16.values, Int16Wrapper(persistedValue: Int16(17)), ltCount: 1)

        validateEquals("mapInt32.@allValues", \Query<CustomPersistableCollections>.mapInt32.values, Int32Wrapper(persistedValue: Int32(32)), notEqualCount: 1)
        validateNumericComparisons("mapInt32.@allValues", \Query<CustomPersistableCollections>.mapInt32.values, Int32Wrapper(persistedValue: Int32(33)), ltCount: 1)

        validateEquals("mapInt64.@allValues", \Query<CustomPersistableCollections>.mapInt64.values, Int64Wrapper(persistedValue: Int64(64)), notEqualCount: 1)
        validateNumericComparisons("mapInt64.@allValues", \Query<CustomPersistableCollections>.mapInt64.values, Int64Wrapper(persistedValue: Int64(65)), ltCount: 1)

        validateEquals("mapFloat.@allValues", \Query<CustomPersistableCollections>.mapFloat.values, FloatWrapper(persistedValue: Float(5.55444333)), notEqualCount: 1)
        validateNumericComparisons("mapFloat.@allValues", \Query<CustomPersistableCollections>.mapFloat.values, FloatWrapper(persistedValue: Float(6.55444333)), ltCount: 1)

        validateEquals("mapDouble.@allValues", \Query<CustomPersistableCollections>.mapDouble.values, DoubleWrapper(persistedValue: 123.456), notEqualCount: 1)
        validateNumericComparisons("mapDouble.@allValues", \Query<CustomPersistableCollections>.mapDouble.values, DoubleWrapper(persistedValue: 234.567), ltCount: 1)

        validateEquals("mapString.@allValues", \Query<CustomPersistableCollections>.mapString.values, StringWrapper(persistedValue: "Foo"), notEqualCount: 1)
        validateStringOperations("mapString.@allValues", \Query<CustomPersistableCollections>.mapString.values,
        ...
        validateEquals("mapBinary.@allValues", \Query<CustomPersistableCollections>.mapBinary.values, DataWrapper(persistedValue: Data(count: 64)), notEqualCount: 1)

        validateEquals("mapDate.@allValues", \Query<CustomPersistableCollections>.mapDate.values, DateWrapper(persistedValue: Date(timeIntervalSince1970: 1000000)), notEqualCount: 1)
        validateNumericComparisons("mapDate.@allValues", \Query<CustomPersistableCollections>.mapDate.values, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2000000)), ltCount: 1)

        validateEquals("mapDecimal.@allValues", \Query<CustomPersistableCollections>.mapDecimal.values, Decimal128Wrapper(persistedValue: Decimal128(123.456)), notEqualCount: 1)
        validateNumericComparisons("mapDecimal.@allValues", \Query<CustomPersistableCollections>.mapDecimal.values, Decimal128Wrapper(persistedValue: Decimal128(234.567)), ltCount: 1)

        validateEquals("mapObjectId.@allValues", \Query<CustomPersistableCollections>.mapObjectId.values, ObjectIdWrapper(persistedValue: ObjectId("61184062c1d8f096a3695046")), notEqualCount: 1)

        validateEquals("mapUuid.@allValues", \Query<CustomPersistableCollections>.mapUuid.values, UUIDWrapper(persistedValue: UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09e")!), notEqualCount: 1)

        validateEquals("mapOptBool.@allValues", \Query<ModernAllTypesObject>.mapOptBool.values, true)

        validateEquals("mapOptInt.@allValues", \Query<ModernAllTypesObject>.mapOptInt.values, 5, notEqualCount: 1)
        validateNumericComparisons("mapOptInt.@allValues", \Query<ModernAllTypesObject>.mapOptInt.values, 6, ltCount: 1)

        validateEquals("mapOptInt8.@allValues", \Query<ModernAllTypesObject>.mapOptInt8.values, Int8(8), notEqualCount: 1)
        validateNumericComparisons("mapOptInt8.@allValues", \Query<ModernAllTypesObject>.mapOptInt8.values, Int8(9), ltCount: 1)

        validateEquals("mapOptInt16.@allValues", \Query<ModernAllTypesObject>.mapOptInt16.values, Int16(16), notEqualCount: 1)
        validateNumericComparisons("mapOptInt16.@allValues", \Query<ModernAllTypesObject>.mapOptInt16.values, Int16(17), ltCount: 1)

        validateEquals("mapOptInt32.@allValues", \Query<ModernAllTypesObject>.mapOptInt32.values, Int32(32), notEqualCount: 1)
        validateNumericComparisons("mapOptInt32.@allValues", \Query<ModernAllTypesObject>.mapOptInt32.values, Int32(33), ltCount: 1)

        validateEquals("mapOptInt64.@allValues", \Query<ModernAllTypesObject>.mapOptInt64.values, Int64(64), notEqualCount: 1)
        validateNumericComparisons("mapOptInt64.@allValues", \Query<ModernAllTypesObject>.mapOptInt64.values, Int64(65), ltCount: 1)

        validateEquals("mapOptFloat.@allValues", \Query<ModernAllTypesObject>.mapOptFloat.values, Float(5.55444333), notEqualCount: 1)
        validateNumericComparisons("mapOptFloat.@allValues", \Query<ModernAllTypesObject>.mapOptFloat.values, Float(6.55444333), ltCount: 1)

        validateEquals("mapOptDouble.@allValues", \Query<ModernAllTypesObject>.mapOptDouble.values, 123.456, notEqualCount: 1)
        validateNumericComparisons("mapOptDouble.@allValues", \Query<ModernAllTypesObject>.mapOptDouble.values, 234.567, ltCount: 1)

        validateEquals("mapOptString.@allValues", \Query<ModernAllTypesObject>.mapOptString.values, "Foo", notEqualCount: 1)
        validateStringOperations("mapOptString.@allValues", \Query<ModernAllTypesObject>.mapOptString.values,
                                 ("Foo", "Foo", "Foo"), matchingCount: 1, notMatchingCount: 1)
        ...
        validateEquals("mapOptBinary.@allValues", \Query<ModernAllTypesObject>.mapOptBinary.values, Data(count: 64), notEqualCount: 1)

        validateEquals("mapOptDate.@allValues", \Query<ModernAllTypesObject>.mapOptDate.values, Date(timeIntervalSince1970: 1000000), notEqualCount: 1)
        validateNumericComparisons("mapOptDate.@allValues", \Query<ModernAllTypesObject>.mapOptDate.values, Date(timeIntervalSince1970: 2000000), ltCount: 1)

        validateEquals("mapOptDecimal.@allValues", \Query<ModernAllTypesObject>.mapOptDecimal.values, Decimal128(123.456), notEqualCount: 1)
        validateNumericComparisons("mapOptDecimal.@allValues", \Query<ModernAllTypesObject>.mapOptDecimal.values, Decimal128(234.567), ltCount: 1)

        validateEquals("mapOptObjectId.@allValues", \Query<ModernAllTypesObject>.mapOptObjectId.values, ObjectId("61184062c1d8f096a3695046"), notEqualCount: 1)

        validateEquals("mapOptUuid.@allValues", \Query<ModernAllTypesObject>.mapOptUuid.values, UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09e")!, notEqualCount: 1)

        validateEquals("mapIntOpt.@allValues", \Query<ModernCollectionsOfEnums>.mapIntOpt.values, EnumInt.value1, notEqualCount: 1)
        validateNumericComparisons("mapIntOpt.@allValues", \Query<ModernCollectionsOfEnums>.mapIntOpt.values, .value2, ltCount: 1)

        validateEquals("mapInt8Opt.@allValues", \Query<ModernCollectionsOfEnums>.mapInt8Opt.values, EnumInt8.value1, notEqualCount: 1)
        validateNumericComparisons("mapInt8Opt.@allValues", \Query<ModernCollectionsOfEnums>.mapInt8Opt.values, .value2, ltCount: 1)

        validateEquals("mapInt16Opt.@allValues", \Query<ModernCollectionsOfEnums>.mapInt16Opt.values, EnumInt16.value1, notEqualCount: 1)
        validateNumericComparisons("mapInt16Opt.@allValues", \Query<ModernCollectionsOfEnums>.mapInt16Opt.values, .value2, ltCount: 1)

        validateEquals("mapInt32Opt.@allValues", \Query<ModernCollectionsOfEnums>.mapInt32Opt.values, EnumInt32.value1, notEqualCount: 1)
        validateNumericComparisons("mapInt32Opt.@allValues", \Query<ModernCollectionsOfEnums>.mapInt32Opt.values, .value2, ltCount: 1)

        validateEquals("mapInt64Opt.@allValues", \Query<ModernCollectionsOfEnums>.mapInt64Opt.values, EnumInt64.value1, notEqualCount: 1)
        validateNumericComparisons("mapInt64Opt.@allValues", \Query<ModernCollectionsOfEnums>.mapInt64Opt.values, .value2, ltCount: 1)

        validateEquals("mapFloatOpt.@allValues", \Query<ModernCollectionsOfEnums>.mapFloatOpt.values, EnumFloat.value1, notEqualCount: 1)
        validateNumericComparisons("mapFloatOpt.@allValues", \Query<ModernCollectionsOfEnums>.mapFloatOpt.values, .value2, ltCount: 1)

        validateEquals("mapDoubleOpt.@allValues", \Query<ModernCollectionsOfEnums>.mapDoubleOpt.values, EnumDouble.value1, notEqualCount: 1)
        validateNumericComparisons("mapDoubleOpt.@allValues", \Query<ModernCollectionsOfEnums>.mapDoubleOpt.values, .value2, ltCount: 1)

        validateEquals("mapStringOpt.@allValues", \Query<ModernCollectionsOfEnums>.mapStringOpt.values, EnumString.value1, notEqualCount: 1)
        validateStringOperations("mapStringOpt.@allValues", \Query<ModernCollectionsOfEnums>.mapStringOpt.values,
                                 (.value1, .value1, .value1), matchingCount: 1, notMatchingCount: 1)
        ...
        validateEquals("mapOptBool.@allValues", \Query<CustomPersistableCollections>.mapOptBool.values, BoolWrapper(persistedValue: true))

        validateEquals("mapOptInt.@allValues", \Query<CustomPersistableCollections>.mapOptInt.values, IntWrapper(persistedValue: 5), notEqualCount: 1)
        validateNumericComparisons("mapOptInt.@allValues", \Query<CustomPersistableCollections>.mapOptInt.values, IntWrapper(persistedValue: 6), ltCount: 1)

        validateEquals("mapOptInt8.@allValues", \Query<CustomPersistableCollections>.mapOptInt8.values, Int8Wrapper(persistedValue: Int8(8)), notEqualCount: 1)
        validateNumericComparisons("mapOptInt8.@allValues", \Query<CustomPersistableCollections>.mapOptInt8.values, Int8Wrapper(persistedValue: Int8(9)), ltCount: 1)

        validateEquals("mapOptInt16.@allValues", \Query<CustomPersistableCollections>.mapOptInt16.values, Int16Wrapper(persistedValue: Int16(16)), notEqualCount: 1)
        validateNumericComparisons("mapOptInt16.@allValues", \Query<CustomPersistableCollections>.mapOptInt16.values, Int16Wrapper(persistedValue: Int16(17)), ltCount: 1)

        validateEquals("mapOptInt32.@allValues", \Query<CustomPersistableCollections>.mapOptInt32.values, Int32Wrapper(persistedValue: Int32(32)), notEqualCount: 1)
        validateNumericComparisons("mapOptInt32.@allValues", \Query<CustomPersistableCollections>.mapOptInt32.values, Int32Wrapper(persistedValue: Int32(33)), ltCount: 1)

        validateEquals("mapOptInt64.@allValues", \Query<CustomPersistableCollections>.mapOptInt64.values, Int64Wrapper(persistedValue: Int64(64)), notEqualCount: 1)
        validateNumericComparisons("mapOptInt64.@allValues", \Query<CustomPersistableCollections>.mapOptInt64.values, Int64Wrapper(persistedValue: Int64(65)), ltCount: 1)

        validateEquals("mapOptFloat.@allValues", \Query<CustomPersistableCollections>.mapOptFloat.values, FloatWrapper(persistedValue: Float(5.55444333)), notEqualCount: 1)
        validateNumericComparisons("mapOptFloat.@allValues", \Query<CustomPersistableCollections>.mapOptFloat.values, FloatWrapper(persistedValue: Float(6.55444333)), ltCount: 1)

        validateEquals("mapOptDouble.@allValues", \Query<CustomPersistableCollections>.mapOptDouble.values, DoubleWrapper(persistedValue: 123.456), notEqualCount: 1)
        validateNumericComparisons("mapOptDouble.@allValues", \Query<CustomPersistableCollections>.mapOptDouble.values, DoubleWrapper(persistedValue: 234.567), ltCount: 1)

        validateEquals("mapOptString.@allValues", \Query<CustomPersistableCollections>.mapOptString.values, StringWrapper(persistedValue: "Foo"), notEqualCount: 1)
        validateStringOperations("mapOptString.@allValues", \Query<CustomPersistableCollections>.mapOptString.values,
                                 (StringWrapper(persistedValue: "Foo"), StringWrapper(persistedValue: "Foo"), StringWrapper(persistedValue: "Foo")), matchingCount: 1, notMatchingCount: 1)
        ...
        validateEquals("mapOptBinary.@allValues", \Query<CustomPersistableCollections>.mapOptBinary.values, DataWrapper(persistedValue: Data(count: 64)), notEqualCount: 1)

        validateEquals("mapOptDate.@allValues", \Query<CustomPersistableCollections>.mapOptDate.values, DateWrapper(persistedValue: Date(timeIntervalSince1970: 1000000)), notEqualCount: 1)
        validateNumericComparisons("mapOptDate.@allValues", \Query<CustomPersistableCollections>.mapOptDate.values, DateWrapper(persistedValue: Date(timeIntervalSince1970: 2000000)), ltCount: 1)

        validateEquals("mapOptDecimal.@allValues", \Query<CustomPersistableCollections>.mapOptDecimal.values, Decimal128Wrapper(persistedValue: Decimal128(123.456)), notEqualCount: 1)
        validateNumericComparisons("mapOptDecimal.@allValues", \Query<CustomPersistableCollections>.mapOptDecimal.values, Decimal128Wrapper(persistedValue: Decimal128(234.567)), ltCount: 1)

        validateEquals("mapOptObjectId.@allValues", \Query<CustomPersistableCollections>.mapOptObjectId.values, ObjectIdWrapper(persistedValue: ObjectId("61184062c1d8f096a3695046")), notEqualCount: 1)

        validateEquals("mapOptUuid.@allValues", \Query<CustomPersistableCollections>.mapOptUuid.values, UUIDWrapper(persistedValue: UUID(uuidString: "33041937-05b2-464a-98ad-3910cbe0d09e")!), notEqualCount: 1)
    ...
    func testMapAllKeysAllValuesSubscript() {
        ...
        validateMapSubscriptEquality("mapInt", \Query<CustomPersistableCollections>.mapInt, value: IntWrapper(persistedValue: 5))
        validateMapSubscriptNumericComparisons("mapInt", \Query<CustomPersistableCollections>.mapInt, value: IntWrapper(persistedValue: 5))
        ...
        validateMapSubscriptEquality("mapOptInt", \Query<CustomPersistableCollections>.mapOptInt, value: IntWrapper(persistedValue: 5))
        validateMapSubscriptNumericComparisons("mapOptInt", \Query<CustomPersistableCollections>.mapOptInt, value: IntWrapper(persistedValue: 5))
    ...
    func testMapContainsAnyInObject() {
        ...
        assertQuery(CustomPersistableCollections.self, "(ANY mapInt IN %@)",
                    values: [NSArray(array: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])], count: 1) {
            $0.mapInt.containsAny(in: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])
        }
        ...
        assertQuery(CustomPersistableCollections.self, "(ANY mapOptInt IN %@)",
                    values: [NSArray(array: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])], count: 1) {
            $0.mapOptInt.containsAny(in: [IntWrapper(persistedValue: 5), IntWrapper(persistedValue: 6)])
        }
    ...
    func testCompoundOr() {
        assertQuery(ModernAllTypesObject.self, "((boolCol == %@) || (intCol == %@))", values: [false, 6], count: 1) {
            $0.boolCol == false || $0.intCol == 6
        }
        assertQuery(ModernAllTypesObject.self, "((boolCol == %@) || (intCol == %@))", values: [false, 6], count: 1) {
            ($0.boolCol == false) || ($0.intCol == 6)
        }
        assertQuery(ModernAllTypesObject.self, "((intCol == %@) || (int8Col == %@))", values: [6, Int8(9)], count: 1) {
        ...
        assertQuery(AllCustomPersistableTypes.self, "((bool == %@) || (int == %@))", values: [BoolWrapper(persistedValue: false), IntWrapper(persistedValue: 6)], count: 1) {
            $0.bool == BoolWrapper(persistedValue: false) || $0.int == IntWrapper(persistedValue: 6)
        }
        assertQuery(AllCustomPersistableTypes.self, "((bool == %@) || (int == %@))", values: [BoolWrapper(persistedValue: false), IntWrapper(persistedValue: 6)], count: 1) {
            ($0.bool == BoolWrapper(persistedValue: false)) || ($0.int == IntWrapper(persistedValue: 6))
        }
        assertQuery(AllCustomPersistableTypes.self, "((int == %@) || (int8 == %@))", values: [IntWrapper(persistedValue: 6), Int8Wrapper(persistedValue: Int8(9))], count: 1) {
            $0.int == IntWrapper(persistedValue: 6) || $0.int8 == Int8Wrapper(persistedValue: Int8(9))
        }
        assertQuery(AllCustomPersistableTypes.self, "((int == %@) || (int8 == %@))", values: [IntWrapper(persistedValue: 6), Int8Wrapper(persistedValue: Int8(9))], count: 1) {
            ($0.int == IntWrapper(persistedValue: 6)) || ($0.int8 == Int8Wrapper(persistedValue: Int8(9)))
        }
        ...
        assertQuery(ModernAllTypesObject.self, "((optBoolCol == %@) || (optIntCol == %@))", values: [false, 6], count: 1) {
            $0.optBoolCol == false || $0.optIntCol == 6
        }
        assertQuery(ModernAllTypesObject.self, "((optBoolCol == %@) || (optIntCol == %@))", values: [false, 6], count: 1) {
            ($0.optBoolCol == false) || ($0.optIntCol == 6)
        }
        assertQuery(ModernAllTypesObject.self, "((optIntCol == %@) || (optInt8Col == %@))", values: [6, Int8(9)], count: 1) {
        ...
        assertQuery(AllCustomPersistableTypes.self, "((optBool == %@) || (optInt == %@))", values: [BoolWrapper(persistedValue: false), IntWrapper(persistedValue: 6)], count: 1) {
            $0.optBool == BoolWrapper(persistedValue: false) || $0.optInt == IntWrapper(persistedValue: 6)
        }
        assertQuery(AllCustomPersistableTypes.self, "((optBool == %@) || (optInt == %@))", values: [BoolWrapper(persistedValue: false), IntWrapper(persistedValue: 6)], count: 1) {
            ($0.optBool == BoolWrapper(persistedValue: false)) || ($0.optInt == IntWrapper(persistedValue: 6))
        }
        assertQuery(AllCustomPersistableTypes.self, "((optInt == %@) || (optInt8 == %@))", values: [IntWrapper(persistedValue: 6), Int8Wrapper(persistedValue: Int8(9))], count: 1) {
            $0.optInt == IntWrapper(persistedValue: 6) || $0.optInt8 == Int8Wrapper(persistedValue: Int8(9))
        }
        assertQuery(AllCustomPersistableTypes.self, "((optInt == %@) || (optInt8 == %@))", values: [IntWrapper(persistedValue: 6), Int8Wrapper(persistedValue: Int8(9))], count: 1) {
            ($0.optInt == IntWrapper(persistedValue: 6)) || ($0.optInt8 == Int8Wrapper(persistedValue: Int8(9)))
        }
        ...
        let sumdoubleCol = 123.456 + 234.567 + 345.678
        assertQuery("((((((arrayCol.@min.doubleCol < %@) || (arrayCol.@max.doubleCol > %@)) || (arrayCol.@sum.doubleCol != %@)) || (arrayCol.@min.doubleCol == %@)) || (arrayCol.@avg.doubleCol >= %@)) || (arrayCol.@avg.doubleCol <= %@))",
                    values: [123.456, 345.678, sumdoubleCol, 0, 345.678, 123.456], count: 3) {
            $0.arrayCol.doubleCol.min < 123.456 ||
            $0.arrayCol.doubleCol.max > 345.678 ||
            $0.arrayCol.doubleCol.sum != sumdoubleCol ||
        ...
        let sumoptDoubleCol = 123.456 + 234.567 + 345.678
        assertQuery("((((((arrayCol.@min.optDoubleCol < %@) || (arrayCol.@max.optDoubleCol > %@)) || (arrayCol.@sum.optDoubleCol != %@)) || (arrayCol.@min.optDoubleCol == %@)) || (arrayCol.@avg.optDoubleCol >= %@)) || (arrayCol.@avg.optDoubleCol <= %@))",
                    values: [123.456, 345.678, sumoptDoubleCol, 0, 345.678, 123.456], count: 3) {
            $0.arrayCol.optDoubleCol.min < 123.456 ||
            $0.arrayCol.optDoubleCol.max > 345.678 ||
            $0.arrayCol.optDoubleCol.sum != sumoptDoubleCol ||
    ...
    func testCompoundMixed() {
        validateCompoundMixed("boolCol", \Query<ModernAllTypesObject>.boolCol, false,
                              "intCol", \Query<ModernAllTypesObject>.intCol, 6)
        validateCompoundMixed("intCol", \Query<ModernAllTypesObject>.intCol, 6,
        ...
        validateCompoundMixed("bool", \Query<AllCustomPersistableTypes>.bool, BoolWrapper(persistedValue: false),
                              "int", \Query<AllCustomPersistableTypes>.int, IntWrapper(persistedValue: 6))
        validateCompoundMixed("int", \Query<AllCustomPersistableTypes>.int, IntWrapper(persistedValue: 6),
        ...
        validateCompoundMixed("optBoolCol", \Query<ModernAllTypesObject>.optBoolCol, false,
                              "optIntCol", \Query<ModernAllTypesObject>.optIntCol, 6)
        validateCompoundMixed("optIntCol", \Query<ModernAllTypesObject>.optIntCol, 6,
        ...
        validateCompoundMixed("optBool", \Query<AllCustomPersistableTypes>.optBool, BoolWrapper(persistedValue: false),
                              "optInt", \Query<AllCustomPersistableTypes>.optInt, IntWrapper(persistedValue: 6))
        validateCompoundMixed("optInt", \Query<AllCustomPersistableTypes>.optInt, IntWrapper(persistedValue: 6),
    ...
    func testAny() {
        ...
        assertQuery(CustomPersistableCollections.self, "(ANY listInt == %@)", IntWrapper(persistedValue: 5), count: 1) {
            $0.listInt == IntWrapper(persistedValue: 5)
        }
        ...
        assertQuery(CustomPersistableCollections.self, "(ANY listOptInt == %@)", IntWrapper(persistedValue: 5), count: 1) {
            $0.listOptInt == IntWrapper(persistedValue: 5)
        }
        ...
        assertQuery(CustomPersistableCollections.self, "(ANY setInt == %@)", IntWrapper(persistedValue: 5), count: 1) {
            $0.setInt == IntWrapper(persistedValue: 5)
        }
        ...
        assertQuery(CustomPersistableCollections.self, "(ANY setOptInt == %@)", IntWrapper(persistedValue: 5), count: 1) {
            $0.setOptInt == IntWrapper(persistedValue: 5)
        }
    ...
    func testCollectionAggregatesAvg() {
        ...
        validateAverage("listFloat", EnumFloat.average(), EnumFloat.value1.rawValue,
                    \Query<LinkToModernCollectionsOfEnums>.object.listFloat.rawValue)
        ...
        validateAverage("listInt", IntWrapper.average(), IntWrapper(persistedValue: 5),
        ...
        validateAverage("listFloatOpt", EnumFloat?.average(), EnumFloat.value1.rawValue,
                    \Query<LinkToModernCollectionsOfEnums>.object.listFloatOpt.rawValue)
        ...
        validateAverage("listOptInt", IntWrapper?.average(), IntWrapper(persistedValue: 5),
        ...
        validateAverage("setFloat", EnumFloat.average(), EnumFloat.value1.rawValue,
                    \Query<LinkToModernCollectionsOfEnums>.object.setFloat.rawValue)
        ...
        validateAverage("setInt", IntWrapper.average(), IntWrapper(persistedValue: 5),
        ...
        validateAverage("setFloatOpt", EnumFloat?.average(), EnumFloat.value1.rawValue,
                    \Query<LinkToModernCollectionsOfEnums>.object.setFloatOpt.rawValue)
        ...
        validateAverage("setOptInt", IntWrapper?.average(), IntWrapper(persistedValue: 5),
        ...
        validateAverage("mapFloat", EnumFloat.average(), EnumFloat.value1.rawValue,
                    \Query<LinkToModernCollectionsOfEnums>.object.mapFloat.rawValue)
        ...
        validateAverage("mapInt", IntWrapper.average(), IntWrapper(persistedValue: 5),
        ...
        validateAverage("mapFloatOpt", EnumFloat?.average(), EnumFloat.value1.rawValue,
                    \Query<LinkToModernCollectionsOfEnums>.object.mapFloatOpt.rawValue)
        ...
        validateAverage("mapOptInt", IntWrapper?.average(), IntWrapper(persistedValue: 5),
    ...
    func testCollectionAggregatesSum() {
        ...
        validateSum("listDouble", EnumDouble.sum(), EnumDouble.value1.rawValue,
                    \Query<LinkToModernCollectionsOfEnums>.object.listDouble.rawValue)
        validateSum("listInt", IntWrapper.sum(), IntWrapper(persistedValue: 5),
                    \Query<LinkToCustomPersistableCollections>.object.listInt)
        ...
        validateSum("listDoubleOpt", EnumDouble?.sum(), EnumDouble.value1.rawValue,
                    \Query<LinkToModernCollectionsOfEnums>.object.listDoubleOpt.rawValue)
        validateSum("listOptInt", IntWrapper?.sum(), IntWrapper(persistedValue: 5),
                    \Query<LinkToCustomPersistableCollections>.object.listOptInt)
        ...
        validateSum("setDouble", EnumDouble.sum(), EnumDouble.value1.rawValue,
                    \Query<LinkToModernCollectionsOfEnums>.object.setDouble.rawValue)
        validateSum("setInt", IntWrapper.sum(), IntWrapper(persistedValue: 5),
                    \Query<LinkToCustomPersistableCollections>.object.setInt)
        ...
        validateSum("setDoubleOpt", EnumDouble?.sum(), EnumDouble.value1.rawValue,
                    \Query<LinkToModernCollectionsOfEnums>.object.setDoubleOpt.rawValue)
        validateSum("setOptInt", IntWrapper?.sum(), IntWrapper(persistedValue: 5),
                    \Query<LinkToCustomPersistableCollections>.object.setOptInt)
        ...
        validateSum("mapDouble", EnumDouble.sum(), EnumDouble.value1.rawValue,
                    \Query<LinkToModernCollectionsOfEnums>.object.mapDouble.rawValue)
        validateSum("mapInt", IntWrapper.sum(), IntWrapper(persistedValue: 5),
                    \Query<LinkToCustomPersistableCollections>.object.mapInt)
        ...
        validateSum("mapDoubleOpt", EnumDouble?.sum(), EnumDouble.value1.rawValue,
                    \Query<LinkToModernCollectionsOfEnums>.object.mapDoubleOpt.rawValue)
        validateSum("mapOptInt", IntWrapper?.sum(), IntWrapper(persistedValue: 5),
                    \Query<LinkToCustomPersistableCollections>.object.mapOptInt)
    ...
    func testCollectionAggregatesMin() {
        ...
        validateMin("listFloat", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.listFloat)
        validateMin("listDouble", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.listDouble)
        validateMin("listInt", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToCustomPersistableCollections>.object.listInt)
        ...
        validateMin("listFloatOpt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.listFloatOpt)
        validateMin("listDoubleOpt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.listDoubleOpt)
        validateMin("listOptInt", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToCustomPersistableCollections>.object.listOptInt)
        ...
        validateMin("setFloat", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.setFloat)
        validateMin("setDouble", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.setDouble)
        validateMin("setInt", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToCustomPersistableCollections>.object.setInt)
        ...
        validateMin("setFloatOpt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.setFloatOpt)
        validateMin("setDoubleOpt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.setDoubleOpt)
        validateMin("setOptInt", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToCustomPersistableCollections>.object.setOptInt)
        ...
        validateMin("mapFloat", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.mapFloat)
        validateMin("mapDouble", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.mapDouble)
        validateMin("mapInt", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToCustomPersistableCollections>.object.mapInt)
        ...
        validateMin("mapFloatOpt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.mapFloatOpt)
        validateMin("mapDoubleOpt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.mapDoubleOpt)
        validateMin("mapOptInt", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToCustomPersistableCollections>.object.mapOptInt)
    ...
    func testCollectionAggregatesMax() {
        ...
        validateMax("listInt64", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.listInt64)
        validateMax("listFloat", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.listFloat)
        validateMax("listDouble", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.listDouble)
        validateMax("listInt", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToCustomPersistableCollections>.object.listInt)
        ...
        validateMax("listInt64Opt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.listInt64Opt)
        validateMax("listFloatOpt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.listFloatOpt)
        validateMax("listDoubleOpt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.listDoubleOpt)
        validateMax("listOptInt", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToCustomPersistableCollections>.object.listOptInt)
        ...
        validateMax("setInt64", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.setInt64)
        validateMax("setFloat", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.setFloat)
        validateMax("setDouble", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.setDouble)
        validateMax("setInt", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToCustomPersistableCollections>.object.setInt)
        ...
        validateMax("setInt64Opt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.setInt64Opt)
        validateMax("setFloatOpt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.setFloatOpt)
        validateMax("setDoubleOpt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.setDoubleOpt)
        validateMax("setOptInt", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToCustomPersistableCollections>.object.setOptInt)
        ...
        validateMax("mapInt64", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.mapInt64)
        validateMax("mapFloat", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.mapFloat)
        validateMax("mapDouble", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.mapDouble)
        validateMax("mapInt", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToCustomPersistableCollections>.object.mapInt)
        ...
        validateMax("mapInt64Opt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.mapInt64Opt)
        validateMax("mapFloatOpt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.mapFloatOpt)
        validateMax("mapDoubleOpt", min: .value1, max: .value3,
                    \Query<LinkToModernCollectionsOfEnums>.object.mapDoubleOpt)
        validateMax("mapOptInt", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToCustomPersistableCollections>.object.mapOptInt)
    ...
    func testKeypathCollectionAggregatesAvg() {
        ...
        validateKeypathAverage("int", IntWrapper.average(), IntWrapper(persistedValue: 5),
        ...
        validateKeypathAverage("optInt", IntWrapper?.average(), IntWrapper(persistedValue: 5),
    ...
    func testKeypathCollectionAggregatesSum() {
        ...
        validateKeypathSum("intEnumCol", ModernIntEnum.sum(), ModernIntEnum.value1.rawValue,
                    \Query<LinkToModernAllTypesObject>.list.intEnumCol.rawValue)
        validateKeypathSum("int", IntWrapper.sum(), IntWrapper(persistedValue: 5),
                    \Query<LinkToAllCustomPersistableTypes>.list.int)
        ...
        validateKeypathSum("optIntEnumCol", ModernIntEnum.sum(), ModernIntEnum.value1.rawValue,
                    \Query<LinkToModernAllTypesObject>.list.optIntEnumCol.rawValue)
        validateKeypathSum("optInt", IntWrapper?.sum(), IntWrapper(persistedValue: 5),
                    \Query<LinkToAllCustomPersistableTypes>.list.optInt)
    ...
    func testKeypathCollectionAggregatesMin() {
        ...
        validateKeypathMin("intEnumCol", min: ModernIntEnum.value1.rawValue, max: ModernIntEnum.value3.rawValue,
                    \Query<LinkToModernAllTypesObject>.list.intEnumCol.rawValue)
        validateKeypathMin("int", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToAllCustomPersistableTypes>.list.int)
        ...
        validateKeypathMin("optIntEnumCol", min: ModernIntEnum.value1.rawValue, max: ModernIntEnum.value3.rawValue,
                    \Query<LinkToModernAllTypesObject>.list.optIntEnumCol.rawValue)
        validateKeypathMin("optInt", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToAllCustomPersistableTypes>.list.optInt)
    ...
    func testKeypathCollectionAggregatesMax() {
        ...
        validateKeypathMax("intEnumCol", min: ModernIntEnum.value1.rawValue, max: ModernIntEnum.value3.rawValue,
                    \Query<LinkToModernAllTypesObject>.list.intEnumCol.rawValue)
        validateKeypathMax("int", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToAllCustomPersistableTypes>.list.int)
        ...
        validateKeypathMax("optIntEnumCol", min: ModernIntEnum.value1.rawValue, max: ModernIntEnum.value3.rawValue,
                    \Query<LinkToModernAllTypesObject>.list.optIntEnumCol.rawValue)
        validateKeypathMax("optInt", min: IntWrapper(persistedValue: 5), max: IntWrapper(persistedValue: 7),
                    \Query<LinkToAllCustomPersistableTypes>.list.optInt)
