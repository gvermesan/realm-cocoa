...
internal class PersistedListAccessor<Element: RealmCollectionValue>: PersistedPropertyAccessor<List<Element>> {
    @objc override class func set(_ property: RLMProperty, on parent: RLMObjectBase, to value: Any) {
...
internal class PersistedSetAccessor<Element: RealmCollectionValue>: PersistedPropertyAccessor<MutableSet<Element>> {
    @objc override class func set(_ property: RLMProperty, on parent: RLMObjectBase, to value: Any) {
        bound(property, parent).pointee.get(parent).assign(value)
    }
    @objc override class func promote(_ property: RLMProperty, on parent: RLMObjectBase) {
...
internal class PersistedMapAccessor<Key: _MapKey, Value: RealmCollectionValue>: PersistedPropertyAccessor<Map<Key, Value>> {
    @objc override class func set(_ property: RLMProperty, on parent: RLMObjectBase, to value: Any) {
        bound(property, parent).pointee.get(parent).assign(value)
    }
    @objc override class func promote(_ property: RLMProperty, on parent: RLMObjectBase) {
...
internal class PersistedLinkingObjectsAccessor<Element: ObjectBase & RealmCollectionValue>: RLMManagedPropertyAccessor {
...
internal class CustomPersistablePropertyAccessor<T: _Persistable>: BridgedPersistedPropertyAccessor<T> {
    @objc override class func set(_ property: RLMProperty, on parent: RLMObjectBase, to value: Any) {
        if coerceToNil(value) == nil {
            super.set(property, on: parent, to: T._rlmDefaultValue(false))
        } else {
