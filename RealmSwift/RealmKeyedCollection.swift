...
public extension RealmKeyedCollection where Value: OptionalProtocol, Value.Wrapped: ObjectBase {
     ...
     */
    func min<T: _PossiblyAggregateable>(of keyPath: KeyPath<Value.Wrapped, T>) -> T? where T.PersistedType: MinMaxType {
    ...
    /**
     ...
     - parameter keyPath: The keyPath of a property whose minimum value is desired.
     */
    func max<T: _PossiblyAggregateable>(of keyPath: KeyPath<Value.Wrapped, T>) -> T? where T.PersistedType: MinMaxType {
    ...
    */
    func sum<T: _PossiblyAggregateable>(of keyPath: KeyPath<Value.Wrapped, T>) -> T where T.PersistedType: AddableType {
     ...
     */
    func average<T: _PossiblyAggregateable>(of keyPath: KeyPath<Value.Wrapped, T>) -> T? where T.PersistedType: AddableType {
...
public extension RealmKeyedCollection where Value: OptionalProtocol, Value.Wrapped: ObjectBase, Value.Wrapped: RealmCollectionValue {
    /**
     ...
     - parameter ascending: The direction to sort in.
     */
    func sorted<T: _PossiblyAggregateable>(by keyPath: KeyPath<Value.Wrapped, T>, ascending: Bool) -> Results<Value> where T.PersistedType: SortableType {
